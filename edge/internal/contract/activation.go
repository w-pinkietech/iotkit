...
func (request ActivationRequest) Validate() error {
	...
	if err := validatePrefixedHex("edge_id", request.EdgeID, "edge-"); err != nil {
		return err
	}
...
func (result ActivationResult) Validate() error {
	...
	if err := validatePrefixedHex("edge_id", result.EdgeID, "edge-"); err != nil {
		return err
	}
...
func (request ActivationRequest) ValidateTopicEdgeNode(edgeNodeID string) error {
...
func (result ActivationResult) ValidateTopicEdgeNode(edgeNodeID string) error {
