...
- [ ] File Structure（新規・変更ファイルの配置）が docs/architecture.md の crate 地図・置き場決定表・層規則に従っているか。新 crate を作るタスクは scripts/check-layers の分類更新と architecture.md の地図更新を含んでいるか。
...
- [ ] 計画5以降の新規の変更系操作は R14 dispatch 経由になっているか。SQL 直書きの変更操作を新設していないか。
