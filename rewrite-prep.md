...
- `core/types`: `AdapterEvent`, `AdapterCommand`, sensor identity/reading, device keys
- `core/engine`: read-model/projection ingesting adapter events
- `core/storage`: SQLite migration/storage handle
- `core/timeseries`: SQLite time-series storage
