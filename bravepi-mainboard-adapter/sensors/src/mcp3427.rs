...
pub fn from_i2c_volts(ch1_volt: f64, ch2_volt: f64) -> SensorReading {
    SensorReading::new(sensor_type(), vec![ch1_volt * 1000.0, ch2_volt * 1000.0], vec!["ch1_volt".into(), "ch2_volt".into()])
}
...
pub fn from_uart_payload(data: &[u8]) -> SensorReading {
    ...
    SensorReading::new(sensor_type(), vec![ch1, ch2], vec!["ch1_volt".into(), "ch2_volt".into()])
}
