...
func TestChangeOwnPasswordVerifiesCurrentPasswordAndClearsTemporaryFlag(t *testing.T) {
	...
	passwordPHC, err := siteauth.HashPassword(currentPassword)
	if err != nil {
		t.Fatal(err)
	}
	repository := &fakeAccountRepository{
...
func (repository *fakeAccountRepository) CreateSiteAccount(
	_ context.Context,
	_ Actor,
	provision AccountProvision,
) (Account, error) {
...
func (repository *fakeAccountRepository) GetSiteAccount(
	context.Context,
	string,
) (Account, error) {
...
func (repository *fakeAccountRepository) GetSiteAccountByLoginID(
	context.Context,
	string,
) (Account, error) {
	return repository.account, nil
...
func (repository *fakeAccountRepository) GetSiteAccountCredential(
	context.Context,
	string,
...
func (repository *fakeAccountRepository) ListSiteAccounts(context.Context) ([]Account, error) {
	return []Account{repository.account}, nil
}

func (repository *fakeAccountRepository) UpdateSiteAccount(
	_ context.Context,
	_ Actor,
	_ string,
	displayName string,
...
func (repository *fakeAccountRepository) DisableSiteAccount(
	_ context.Context,
	_ Actor,
	_ string,
	_ int64,
...
func (repository *fakeAccountRepository) ReplaceSiteAccountPassword(
	_ context.Context,
	_ Actor,
	_ string,
	_ string,
